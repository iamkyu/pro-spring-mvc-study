...
import com.chap04.controller.ConfigurableDispatcherServlet;
...
public abstract class AbstractDispatcherServletTest implements AfterRunService {
    ...
    public AbstractDispatcherServletTest initRequest(String requestUri, RequestMethod requestMethod) {
        return this.initRequest(requestUri, requestMethod.toString());
    }
